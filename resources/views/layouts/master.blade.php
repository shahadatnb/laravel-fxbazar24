                ...
                @if(Auth::user()->admin==1)
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu bg-dark border">
                            ...
                            <li><i class="menu-icon fa fa-fort-awesome"></i><a href="{{ url('/home')}}">Referral Income Report</a></li>
                            <li><i class="menu-icon fa fa-fort-awesome"></i><a href="{{ url('/home')}}">Generation Income Report</a></li>
                            <li><i class="menu-icon fa fa-fort-awesome"></i><a href="{{ url('/home')}}">Matching Income Report</a></li>
                            <li><i class="menu-icon fa fa-fort-awesome"></i><a href="{{ url('/home')}}">Work Sponsor Income Report</a></li>
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu bg-dark border">
                            ...
                            <li><i class="menu-icon fa fa-fort-awesome"></i><a href="{{ url('/memberList')}}">My Sponsored Records</a></li>
